...
import MessengerOne from './Pages/messenger/Messenger';
import MassangerIcon from './Components/MassangerIcon/MassangerIcon';
...
function App() {
  ...
  const Messenger = withLoading(MessengerOne);
    ...
    <div className="App">
      ...
      <Routes location={location} key={location.pathname}>
        {blockedPatient === true ? (
          ...
          <Route path='/Posts/:postId?/:commentId?' element={<PostsWithLoading />} />
          <Route path='nurseProfile' element={<NurseProfilePageWithLoading />} />
          ...
          <Route path="/ShowNurseProfile/:id" element={<ShowNurseProfileWithLoading  />} />
          <Route path="/FormNurse/:id" element={<NurseFormWithLoading />}/>
          ...
          <Route path="/NurseProfileComponent" element={<NurseProfileWithLoading />} />
          <Route path="/Messenger/:patientID?/:nurseID?" element={<Messenger />} />
          </>
